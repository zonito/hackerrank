...
# on them. She starts following the trail and notices that two consecutive
...
# Input Format
# The first line contains an integer T i.e. the number of Test cases. T
# testcases follow. Each testcase has 3 lines. The first line contains n ( the
# number of steps ) The second line contains a. The third line contains b.
