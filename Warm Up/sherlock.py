...
# Input Format
# The 1st line will contain an integer T, the number of test cases, followed by
# T lines, each line containing an integer N i.e. the number of digits in the
# number
...
for _ in range(input()):
    ...
    if y < 0:
        ...
        print (''.join('5' for i in range(3 * y))
               + ''.join('3' for j in range(5 * x)))
